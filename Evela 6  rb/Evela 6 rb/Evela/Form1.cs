...
namespace Evela
{
    public partial class Form1 : Form
    {
        ...
        string qw;// вопрос
        string[] answ = new string[5];//Вариант ответа
        ...
        private void showQw()
        {
            ...
            //radioButton5.Top = radioButton2.Top + 24;
            radioButton5.Text = answ[3];
            //radioButton6.Top = radioButton2.Top + 24;
            radioButton6.Text = answ[4];
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if ((RadioButton) sender == radioButton4) otv = 0;
            if ((RadioButton) sender == radioButton5) otv = 0;
